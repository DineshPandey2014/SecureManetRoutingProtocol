...
app.post('/form', function(req, res) {
   var userData = req.body.userdata;
    if(userData !== 'undefined') {
        var message = encrypt(key, userData);
        ...
        serverError.on('message', function (errormessage, remote) {
            var decryptedText = decrypt(key, errormessage);
            if(decryptedText == 'Data_Received_Successfully') {
                console.log("Data equals is working");
            } else {
                console.log("Data equals is not working");
            }
            console.log(remote.address + ':' + remote.port + ' - ' + decryptedText);
            res.render('baseTemplate.ejs', {
                statusmessage: decryptedText,
            });
            // console.log(remote.address + ':' + remote.port +' - ' + errormessage);
        });
    }
});
...
function decrypt(key, data) {
    ...
    try {
        ...
        console.log("---Hello Dinesh There is error.");
